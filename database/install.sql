-- Полная установка БД ooofix-xmlupd-cloud
-- Запуск (из корня проекта на сервере):
--   mysql -u root -p < database/install.sql
--
-- Или с указанием хоста:
--   mysql -h localhost -u root -p < database/install.sql

CREATE DATABASE IF NOT EXISTS ooofix_xmlupd_cloud
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE ooofix_xmlupd_cloud;
